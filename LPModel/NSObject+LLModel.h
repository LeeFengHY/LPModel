 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `LLModel` protocol for custom methods.
 
 
 Sample Code:
 
 ********************** json convertor *********************
 @interface LLAuthor : NSObject
 @property (nonatomic, strong) NSString *name;
 @property (nonatomic, assign) NSDate *birthday;
 @end
 @implementation LLAuthor
 @end
 
 @interface LLBook : NSObject
 @property (nonatomic, copy) NSString *name;
 @property (nonatomic, assign) NSUInteger pages;
 @property (nonatomic, strong) LLAuthor *author;
 @end
 @implementation LLBook
 @end
 
 int main() {
 // create model from json
 LLBook *book = [LLBook LL_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
 // convert model to json
 NSString *json = [book LL_modelToJSONString];
 // {"author":{"name":"J.K.Rowling","birthday":"1965-07-31T00:00:00+0000"},"name":"Harry Potter","pages":256}
 }
 
 ********************** Coding/Copying/hash/equal *********************
 @interface LLShadow :NSObject <NSCoding, NSCopying>
 @property (nonatomic, copy) NSString *name;
 @property (nonatomic, assign) CGSize size;
 @end
 
 @implementation LLShadow
 - (void)encodeWithCoder:(NSCoder *)aCoder { [self LL_modelEncodeWithCoder:aCoder]; }
 - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self LL_modelInitWithCoder:aDecoder]; }
 - (id)copyWithZone:(NSZone *)zone { return [self LL_modelCopy]; }
 - (NSUInteger)hash { return [self LL_modelHash]; }
 - (BOOL)isEqual:(id)object { return [self LL_modelIsEqual:object]; }
 @end
 
 */

+ (nullable instancetype)ll_modelWithJSON:(nullable id)json;
 ...
 */
+ (nullable instancetype)ll_modelWithDictionary:(nullable NSDictionary *)dictionary;
/**
 ...
 `NSString` -> NSDate, parsed with format "LLLL-MM-dd'T'HH:mm:ssZ", "LLLL-MM-dd HH:mm:ss" or "LLLL-MM-dd".
 `NSString` -> NSURL.
...
- (nullable id)ll_modelToJSONObject;
/**
 ...
 */
- (nullable NSData *)ll_modelToJSONData;
/**
...
@interface NSDictionary (LLModel)
/**
 ...
 @return A array, or nil if an error occurs.
 */
+ (nullable NSDictionary *)ll_modelDictionaryWithClass:(Class)cls json:(id)json;
@end

@protocol LLModel <NSObject>
...
/**
 ...
 Example:
 @class LLShadow, LLBorder, LLAttachment;
 
 @interface LLAttributes
 @property NSString *name;
 ...
 @implementation LLAttributes
 + (NSDictionary *)modelContainerPropertyGenericClass {
 return @{@"shadows" : [LLShadow class],
 @"borders" : LLBorder.class,
 @"attachments" : @"LLAttachment" };
 }
 @end
...
/**
 ...
 Example:
 @class LLCircle, LLRectangle, LLLine;
 
 @implementation LLShape
 
 + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
 if (dictionary[@"radius"] != nil) {
 return [LLCircle class];
 } else if (dictionary[@"width"] != nil) {
 return [LLRectangle class];
